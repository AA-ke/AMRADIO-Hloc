...
def filter_matches_with_ransac(kpts1, kpts2, matches, ransac_thresh=25.0):
    """
...
# 加载图片
img1 = Image.open('examples/north_000037.jpg').convert("RGB")
img2 = Image.open('examples/qie2_0037.jpg').convert("RGB")
